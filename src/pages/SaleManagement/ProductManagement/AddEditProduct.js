                        ...
                        <div className="grid">
                                            ...
                                            <div className="grid Variants">
                                                ...
                                                <div className="col-12 md:col-6 lg:col-6 xl:col-6">
                                                    <div className="flex flex-column">
                                                        ...
                                                        <InputText name="sku" placeholder="Enter SKU" value={x.sku} onChange={(e) => handleInputChange(e, i)} className={classNames({ "p-invalid": isFormFieldValid("sku") }, "w-full md:w-10 inputClass")} />
                            ...
                            <div className="col-12 md:col-12 lg:col-12 xl:col-12">
                                <div className="flex flex-column">
                                    ...
                                    <Editor id="description" name="description" style={{ height: "320px" }} value={htmlText} onTextChange={(e) => setHtmlText(e.htmlValue)} />
