...
const OrderRetured = (props) => {
  ...
  //  const [deliveryPartner, setDeliveryPaetner] = useState();
    ...
    const handleDispatch = async () => {
        ...
        const res = await dispatch(handlePostRequest(data,"api/v1/returnOrder/dispatchReturnOrder",false));
    ...
    const statusOption = [
        { name: 'Returned', orderStatus: 'Returned' },
            ...
            <div className="grid p-p-3">
                ...
                <div className="col-12 md:col-12 lg:col-12 xl:col-12">
                    <div className="flex flex-column">
                        ...
                        <InputText type="text" id="message" name="message" placeholder="Message" className="w-full md:w-10 inputClass"  />
                    </div>
                ...
                <div className="col-12 text-center">
                    ...
                    <Button disabled={loading} iconPos="right" label={"Retured"} autoFocus className="Savebtn p-mr-3"
